...
/**
 * Provider abstraction. Every LLM backend (Anthropic, OpenAI, Gemini,
 * OpenRouter, Ollama) implements `AIProvider`, so adding a new backend is a
 * single adapter file — the rest of the app talks only to this interface.
 *
