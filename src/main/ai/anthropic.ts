 ...
 *
 * Auth is an Anthropic API key (from console.anthropic.com). Consumer
 * (Claude Pro/Max) OAuth tokens are intentionally NOT supported — since
 * Jan 2026 Anthropic blocks those outside Claude Code / Claude.ai.
 */
