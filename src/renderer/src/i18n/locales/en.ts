...
export const en = {
  ...
  // Risk Detector
  'ab.risk': 'Risk Detector',
  'risk.title': 'Risk Detector',
  'risk.noWorkspace': 'Open a folder to detect risky areas.',
  'risk.refresh': 'Rescan changes',
  'risk.inProgress': 'Risky changes in progress',
  'risk.noneInProgress': 'No uncommitted changes in critical areas.',
  'risk.banner': '{n} high-risk file(s) have uncommitted changes',
  'risk.zones': 'Danger zones',
  'risk.noZones': 'No critical areas detected in this project.',
  'risk.recommended': 'Recommended:',
  'risk.snapshot': '📸 Snapshot first',
  'risk.review': 'Review with Claude Code',
  'risk.cat.migration': 'Database migration',
  'risk.cat.database': 'Database',
  'risk.cat.payments': 'Payments',
  'risk.cat.auth': 'Authentication',
  'risk.cat.secrets': 'Secrets',
  'risk.cat.infra': 'Infrastructure',
  'risk.cat.deploy': 'Deployment / CI',
  'risk.cons.migration': 'Existing data may become incompatible, and the change can be hard to reverse.',
  'risk.cons.database': 'Data-shape changes can break reads and writes elsewhere.',
  'risk.cons.payments': 'Money-handling bugs are high-impact and hard to undo.',
  'risk.cons.auth': 'Mistakes can lock users out or leak access.',
  'risk.cons.secrets': 'Secrets can leak into git history or logs.',
  'risk.cons.infra': 'Can affect production availability and other services.',
  'risk.cons.deploy': 'Can break releases or expose production.',
  'risk.rec.migration': 'Snapshot/back up first · add a migration test · try it on staging, not production.',
  'risk.rec.database': 'Back up first · add tests around the change · review carefully.',
  'risk.rec.payments': 'Use test/sandbox keys · add edge-case tests · get a second review.',
  'risk.rec.auth': 'Add tests for expired/invalid sessions · review carefully · snapshot first.',
  'risk.rec.secrets': 'Never commit real secrets · use env vars · rotate anything exposed.',
  ...
  // AI Activity Center
  'ab.activity': 'AI Activity',
  'act.title': 'AI Activity',
  'act.live': 'Now',
  'act.idle': 'Nothing running right now.',
  'act.log': 'Activity log',
  'act.empty': 'No activity yet this session.',
  'act.clear': 'Clear log',
  'act.src.claude': 'Claude Code',
  'act.src.brain': 'Project Brain',
  'act.src.heal': 'Self-Healing',
  'act.src.bug': 'Bug Detective',
  'act.src.tests': 'Test Guardian',
  'act.src.watcher': 'Code Watcher',
  'act.brain.indexing': 'Analyzing the project…',
  'act.brain.indexed': 'Indexed {n} files',
  'act.brain.error': 'Indexing failed',
  'act.claude.working': 'Working…',
  'act.claude.done': 'Finished — {n} file(s) changed',
  'act.claude.error': 'Stopped with an error',
  'act.heal.start': 'Self-Healing started',
  'act.heal.passed': 'All checks pass',
  'act.heal.failed': 'Could not fully resolve',
  'act.heal.stopped': 'Stopped',
  'act.bug.investigating': 'Investigating: {q}',
  'act.tests.running': 'Running tests…',
  'act.tests.passed': 'Tests passed',
  'act.tests.failed': 'Tests failed',
  'act.create.creating': 'Creating {name}…',
  'act.create.created': 'Created {name}',

  // Project Creation Engine
  'create.newProject': 'New Project',
  'create.title': 'Create a New Project',
  'create.whatToBuild': 'What do you want to build?',
  'create.descPlaceholder': 'e.g. A React music player with a playlist, search and dark mode',
  'create.analyze': 'Continue →',
  'create.name': 'Project name',
  'create.location': 'Location',
  'create.noLocation': 'No folder chosen',
  'create.browse': 'Browse…',
  'create.stack': 'Recommended stack',
  'create.features': 'Features',
  'create.noFeatures': 'No specific features detected — you can add them later.',
  'create.back': '← Back',
  'create.create': 'Create Project',
  'create.creating': 'Creating…',
  'create.done': 'Project "{name}" is ready.',
  'create.doneSub': '{n} files created and indexed by Project Brain.',
  'create.nextSteps': 'Next steps',
  'create.install': 'Install dependencies',
  'create.installDesc': 'Runs the install command in the terminal.',
  'create.implement': 'Implement with Claude Code',
  'create.implementDesc': 'Hand the goal + features to Claude Code to build.',
  'create.openGoal': 'Open Goal Mode',
  'create.openGoalDesc': 'Track progress from your real code.',
  'create.verify': 'Run Self-Healing check',
  'create.verifyDesc': 'Typecheck / build / test, and auto-fix failures.',
  'create.finish': 'Done',
